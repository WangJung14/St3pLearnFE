...
const ROLE_SHELLS: Record<UserRole, RoleShellConfig> = {
  STUDENT: {
    ...
    nav: [
      { label: "Tổng quan", href: "/dashboard/student", icon: LayoutDashboard },
      { label: "Khóa học", href: "/courses", icon: BookOpen },
      { label: "Wishlist", href: "/dashboard/student/wishlist", icon: Heart },
      { label: "Từ vựng", href: "/dashboard/student/vocabulary", icon: Brain },
      { label: "Chứng chỉ", href: "/dashboard/student/certificates", icon: Award },
    ],
  },
  TEACHER: {
    ...
    nav: [
      ...
      { label: "Tạo khóa học", href: "/dashboard/teacher/courses/new", icon: PlusCircle },
      { label: "Danh mục", href: "/courses", icon: BookOpen },
    ],
  },
  ADMIN: {
    label: "Admin Console",
    ...
    nav: [
      ...
      { label: "Duyệt khóa học", href: "/dashboard/admin/approvals", icon: ClipboardCheck },
  ...
  MENTOR: {
    ...
    nav: [
      ...
      { label: "Học viên", href: "/dashboard/mentor", icon: Users },
  ...
  MODERATOR: {
    ...
    nav: [
      { label: "Tổng quan", href: "/dashboard/moderator", icon: LayoutDashboard },
