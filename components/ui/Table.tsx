...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn("hover:bg-gray-50/40 transition-colors", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "px-6 py-4 text-gray-400 text-2xs font-extrabold uppercase tracking-wider",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("px-6 py-4 text-gray-700 font-medium align-middle", className)}
    {...props}
  />
));
